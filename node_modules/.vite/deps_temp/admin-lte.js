    ...
    !function(e, t) {
      ...
      class k {
        ...
        collapse() {
          ...
          if (this._parent) {
            ...
            const e3 = (_a = this._parent) == null ? void 0 : _a.querySelectorAll(`${L}, ${w}`);
            e3.forEach((e4) => {
          ...
          (_b = this._element) == null ? void 0 : _b.dispatchEvent(e2);
        }
        expand() {
          var _a, _b;
        ...
        remove() {
          ...
          this._parent && i(this._parent, this._config.animationSpeed), (_a = this._element) == null ? void 0 : _a.dispatchEvent(e2);
        }
        toggle() {
          var _a;
          ((_a = this._parent) == null ? void 0 : _a.classList.contains(p)) ? this.expand() : this.collapse();
        }
        maximize() {
          var _a;
          ...
          }, 150)), (_a = this._element) == null ? void 0 : _a.dispatchEvent(e2);
        }
        minimize() {
          var _a;
          ...
          this._parent && (this._parent.style.height = "auto", this._parent.style.width = "auto", this._parent.style.transition = "all .15s", setTimeout(() => {
            var _a2;
            const e3 = document.querySelector("html");
            e3 && e3.classList.remove(b), this._parent && (this._parent.classList.remove(b), ((_a2 = this._parent) == null ? void 0 : _a2.classList.contains(v)) && this._parent.classList.remove(v));
          }, 10)), (_a = this._element) == null ? void 0 : _a.dispatchEvent(e2);
        }
        toggleMaximize() {
          var _a;
          ((_a = this._parent) == null ? void 0 : _a.classList.contains(b)) ? this.minimize() : this.maximize();
        }
      }
      n(() => {
      ...
      class P {
        ...
        open() {
          ...
          if (this._config.accordion) {
            const e3 = (_a = this._element.parentElement) == null ? void 0 : _a.querySelectorAll(`${M}.${$}`);
            e3 == null ? void 0 : e3.forEach((e4) => {
              if (e4 !== this._element.parentElement) {
                e4.classList.remove($);
                const t3 = e4 == null ? void 0 : e4.querySelector(D);
                t3 && i(t3, this._config.animationSpeed);
              }
            });
          }
          this._element.classList.add($);
          const t2 = (_b = this._element) == null ? void 0 : _b.querySelector(D);
        ...
        close() {
          ...
          const t2 = (_a = this._element) == null ? void 0 : _a.querySelector(D);
      ...
      n(() => {
        document.querySelectorAll('[data-lte-toggle="treeview"]').forEach((e2) => {
          e2.addEventListener("click", (e3) => {
            ...
            if ("#" !== (t2 == null ? void 0 : t2.getAttribute("href")) && "#" !== (i2 == null ? void 0 : i2.getAttribute("href")) || e3.preventDefault(), n2) {
      ...
      class ie {
        ...
        menusClose() {
          ...
          const e2 = document.querySelector(".sidebar-menu"), t2 = e2 == null ? void 0 : e2.querySelectorAll(".nav-item");
          t2 && t2.forEach((e3) => {
        ...
        addSidebarBreakPoint() {
          var _a, _b, _c;
          const e2 = (_b = (_a = document.querySelector(ee)) == null ? void 0 : _a.classList) != null ? _b : [], t2 = (_c = Array.from(e2).find((e3) => e3.startsWith(Z))) != null ? _c : "", n2 = document.getElementsByClassName(t2)[0], i2 = globalThis.getComputedStyle(n2, "::before").getPropertyValue("content");
      ...
      n(() => {
        var _a;
        const e2 = document == null ? void 0 : document.querySelector(".app-sidebar");
        if (e2) {
        ...
        t2.className = "sidebar-overlay", (_a = document.querySelector(".app-wrapper")) == null ? void 0 : _a.append(t2), t2.addEventListener("touchstart", (e3) => {
          e3.preventDefault();
          ...
          e3.addEventListener("click", (e4) => {
            ...
            "sidebar" !== (t3 == null ? void 0 : t3.dataset.lteToggle) && (t3 = t3 == null ? void 0 : t3.closest(te)), t3 && (e4 == null ? void 0 : e4.preventDefault(), new ie(t3, ne).toggle());
          });
        });
      });
      class oe {
        constructor(e2 = {}) {
          ...
          __publicField(this, "focusHistory", []);
        ...
        handleTabNavigation(e2) {
          ...
          e2.shiftKey ? n2 <= 0 && (e2.preventDefault(), (_a = t2.at(-1)) == null ? void 0 : _a.focus()) : n2 >= t2.length - 1 && (e2.preventDefault(), (_b = t2[0]) == null ? void 0 : _b.focus());
        }
        ...
        handleEscapeKey(e2) {
          ...
          if (t2) {
            ...
            n3 == null ? void 0 : n3.click(), e2.preventDefault();
          } else if (n2) {
            const t3 = document.querySelector('[data-bs-toggle="dropdown"][aria-expanded="true"]');
            t3 == null ? void 0 : t3.click(), e2.preventDefault();
          }
        }
        ...
        handleMenuNavigation(e2) {
          var _a, _b;
          if (!["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "Home", "End"].includes(e2.key))
            return;
          const t2 = e2.target, n2 = Array.from(((_a = t2.closest(".nav, .navbar-nav, .dropdown-menu")) == null ? void 0 : _a.querySelectorAll("a, button")) || []), i2 = n2.indexOf(t2);
          let o2;
          switch (e2.key) {
            case "ArrowDown":
            case "ArrowRight":
          ...
          e2.preventDefault(), (_b = n2[o2]) == null ? void 0 : _b.focus();
        }
        ...
        initFormAccessibility() {
          document.querySelectorAll("input, select, textarea").forEach((e2) => {
            var _a, _b;
            const t2 = e2;
            if (!((_a = t2.labels) == null ? void 0 : _a.length) && !t2.hasAttribute("aria-label") && !t2.hasAttribute("aria-labelledby")) {
              const e3 = t2.getAttribute("placeholder");
              e3 && t2.setAttribute("aria-label", e3);
            }
            if (t2.hasAttribute("required")) {
              const e3 = (_b = t2.labels) == null ? void 0 : _b[0];
        ...
        handleFormError(e2) {
          ...
          n2 || (n2 = document.createElement("div"), n2.id = t2, n2.className = "invalid-feedback", n2.setAttribute("role", "alert"), (_a = e2.parentNode) == null ? void 0 : _a.insertBefore(n2, e2.nextSibling)), n2.textContent = e2.validationMessage, e2.setAttribute("aria-describedby", t2), e2.classList.add("is-invalid"), this.announce(`Error in ${((_c = (_b = e2.labels) == null ? void 0 : _b[0]) == null ? void 0 : _c.textContent) || e2.name}: ${e2.validationMessage}`, "assertive");
        }
        ...
        initDropdownFocusManagement() {
          document.addEventListener("shown.bs.dropdown", (e2) => {
            const t2 = e2.target.querySelector(".dropdown-menu"), n2 = t2 == null ? void 0 : t2.querySelector("a, button");
            n2 && n2.focus();
          });
        }
        ...
        trapFocus(e2) {
          ...
          e2.addEventListener("keydown", (e3) => {
            "Tab" === e3.key && (e3.shiftKey ? document.activeElement === i2 && (o2 == null ? void 0 : o2.focus(), e3.preventDefault()) : document.activeElement === o2 && (i2.focus(), e3.preventDefault()));
          });
        }
        addLandmarks() {
